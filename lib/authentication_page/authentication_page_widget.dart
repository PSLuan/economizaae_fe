...
class _AuthenticationPageWidgetState extends State<AuthenticationPageWidget>
  ...
  void initState() {
    ...
    _model.retypePasswordRegisterController ??= TextEditingController();
    _model.retypePasswordRegisterFocusNode ??= FocusNode();
                                ...
                                children: [
                                  Align(
                                    child: TabBar(
                                      ...
                                      indicatorColor: const Color(0xFF78618F),
                                      indicatorWeight: 3,
                                                ...
                                                children: [
                                                  ...
                                                  Padding(
                                                    padding:
                                                        const EdgeInsetsDirectional
                                                            ...
                                                            0, 4, 0, 24),
                                                    child: Text(
                                                      'Para criar sua conta, preencha os dados abaixo.',
                                                      textAlign:
                                                          TextAlign.start,
                                                      style: FlutterFlowTheme
                                                              .of(context)
                                                  ...
                                                  Padding(
                                                    ...
                                                    child: SizedBox(
                                                      ...
                                                      child: TextFormField(
                                                        controller: _model
                                                            .retypePasswordRegisterController,
                                                        focusNode: _model
                                                            .retypePasswordRegisterFocusNode,
                                                        autofocus: true,
                                                        autofillHints: const [
                                                          AutofillHints.password
                                                        ],
                                                        obscureText: !_model
                                                            .retypePasswordRegisterVisibility,
                                                        decoration:
                                                            InputDecoration(
                                                          labelText:
                                                              'Confirmar senha',
                                                          ...
                                                          suffixIcon: InkWell(
                                                            ...
                                                            focusNode: FocusNode(
                                                                skipTraversal:
                                                                    true),
                                                            child: Icon(
                                                              _model.retypePasswordRegisterVisibility
                                                                  ? Icons
                                                                      .visibility_outlined
                                                                  : Icons
                                                                      .visibility_off_outlined,
                                                  ...
                                                  Padding(
                                                    padding:
                                                        const EdgeInsetsDirectional
                                                            ...
                                                            0.0, 24.0),
                                                    child: Text(
                                                      'Para entrar no aplicativo, digite suas informações abaixo.',
                                                      textAlign:
                                                          TextAlign.start,
                                                      style: FlutterFlowTheme
                                                              .of(context)
